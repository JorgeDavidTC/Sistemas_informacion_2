...
// Configuración de conexión a la base de datos admisiones
define('DB_HOST', 'localhost');
define('DB_USER', 'root');
define('DB_PASS', '');
define('DB_NAME', 'admisiones');
...
$query = "SELECT nombre, email, es_admin FROM usuarios WHERE id_usuario = ? LIMIT 1";
...
// Obtener ranking de carreras (basado en vista vw_ranking_carreras)
$ranking_query = "SELECT nombre, postulantes_count, porcentaje_total FROM vw_ranking_carreras LIMIT 10";
...
<main>
    ...
    <p>Email registrado: <?= htmlspecialchars($usuario['email']) ?></p>
