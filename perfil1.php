...
<div class="container">
    ...
    <?php if (!$modo_editar): ?>
        ...
        <a href="perfil1.php?editar=1"><button class="btn-edit">Editar Perfil</button></a>
        <button class="btn-back" onclick="window.location.href='postulante_dashboard3.php'">Volver</button>

    <?php else: ?>
        <form method="post" action="perfil1.php" enctype="multipart/form-data">
            <label>Nombre:
            ...
            <button type="button" class="btn-back" onclick="window.location.href='perfil1.php';">Cancelar</button>
        </form>
    <?php endif; ?>
</div>
</body>
